      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-6">
            ...
            <p className="text-sm text-white text-justify pr-10">
          ...
          <div className="w-full md:w-1/4 mb-6">
            ...
            <ul>
              <li className="mb-2">
                <a href="#" className="text-sm hover:text-gray-400 text-white">Home</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-sm hover:text-gray-400 text-white">About Us</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-sm hover:text-gray-400 text-white">Services</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-sm hover:text-gray-400 text-white">Contact</a>
              </li>
            </ul>
          </div>
          <div className="w-full md:w-1/4 mb-6">
            ...
            <ul>
              <li className="mb-2">
                <a href="#" className="text-sm hover:text-gray-400 text-white">Blog</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-sm hover:text-gray-400 text-white">FAQs</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-sm hover:text-gray-400 text-white">Support</a>
              </li>
              <li className="mb-2">
                <a href="#" className="text-sm hover:text-gray-400 text-white">Privacy Policy</a>
              </li>
            </ul>
          </div>
          <div className="w-full md:w-1/4 mb-6">
            <h5 className="font-bold text-lg mb-4 text-white">Contact Us</h5>
            <p className="text-sm mb-2 text-white">123 Main Street, Anytown, USA</p>
            <p className="text-sm mb-2 text-white">Email: info@zerohunger.com</p>
            <p className="text-sm mb-2 text-white">Phone: (123) 456-7890</p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center">
          <p className="text-sm text-white">&copy; 2024 Zero Hunger. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
